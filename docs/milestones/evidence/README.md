...
| `ios-m3-cold-launch.png` | Fresh 2026-09-20 signed iOS Firebase-linked build cold-launched without the opt-in spike flag; Foundation Home remains the default UI. |
| `android-m3-cold-launch.png` | Fresh 2026-09-20 Android Firebase-linked debug build cold-launched; Foundation Home remains the default UI. |
